import { fetchUsersController, createUserController } from "@/controllers/usersController";
  ...
  return (
    <div className="max-w-xl mx-auto p-4">
      ...
      <form action={createUserController} className="mt-6 space-y-2">
        ...
        <button className="bg-blue-600 text-white px-4 py-2 rounded">افزودن کاربر</button>
      </form>
    </div>
  );
}
